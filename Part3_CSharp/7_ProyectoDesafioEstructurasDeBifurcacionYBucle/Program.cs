...
Console.WriteLine("----------------------------------------------------------------------");
Console.WriteLine("7_Proyecto Desafío: Estructuras de bifurcación y bucle");
Console.WriteLine("----------------------------------------------------------------------");
...
Especificación
En este ejercicio de desafío, debe desarrollar una característica que garantice que las edades de los animales y las descripciones físicas estén completas.
...
Omite cualquier animal en el array ourAnimals cuando el valor de pet ID esté establecido en el valor por defecto.

Muestra el valor del identificador de mascota y solicita al usuario un valor de datos actualizado si faltan o están incompletos los datos de la matrizAnimals.
...
Informe al usuario de la aplicación cuando se cumplan todos los requisitos de datos, pausando la aplicación para asegurarse de que se puede ver y responder el mensaje.
*/
